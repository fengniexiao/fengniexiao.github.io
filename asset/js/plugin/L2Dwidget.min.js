...
var L2Dwidget = exports.L2Dwidget = function (t) {
  ...
  var r = e(2),
    ...
    _s = function s() {
      var t,
        n = e(17)("iframe"),
        r = i.length;
      for (n.style.display = "none", e(32).appendChild(n), n.src = "javascript:", (t = n.contentWindow.document).open(), t.write("<script>document.F=Object<\/script>"), t.close(), _s = t.F; r--;) delete _s[a][i[r]];
      return _s();
    };
