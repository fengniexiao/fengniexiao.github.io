...
const L2Dwidget = exports.L2Dwidget = function (t) {
  ...
  t.exports = function (t, n, e, y, m, b, w) {
    ...
    if (M && (_ = l(M.call(new t()))) !== Object.prototype && _.next && (f(_, k, !0), r || u(_, p) || c(_, p, h)), P && T && T.name !== v && (j = !0, L = function () {
      return T.call(this);
    }), r && !w || !d && !j && O[p] || c(O, p, L), a[n] = L, a[k] = h, m) if (g = {
      values: P ? L : S(v),
      keys: b ? L : S("keys"),
      entries: E
    }, w) for (x in g) x in O || i(O, x, g[x]);else o(o.P + o.F * (d || j), n, g);
    return g;
  };
}, function (t, n) {
  t.exports = !1;
  ...
  for (var r = e(57), o = e(29), i = e(5), c = e(1), u = e(3), a = e(9), s = e(0), f = s("iterator"), l = s("toStringTag"), p = a.Array, d = {
    ...
    var y,
        ...
        w = c[m],
        g = w && w.prototype;
    if (g && (g[f] || u(g, f, p), g[l] || u(g, l, m), a[m] = p, b)) for (y in r) g[y] || i(g, y, r[y], !0);
  }
}, function (t, n, e) {
  "use strict";
  ...
  L || (P = function (t) {
    ...
    Promise: P
  }), e(22)(P, _), e(69)(_), c = e(4)[_], l(l.S + l.F * !L, _, {
    reject: function (t) {
      var n = T(this);
  ...
  (n = t.exports = function (t, n, e, l, p) {
    ...
    if (i(m)) {
      for (d = u(t.length); d > w; w++) if ((y = n ? b(c(v = t[w])[0], v[1]) : b(t[w])) === s || y === f) return y;
    } else for (h = m.call(t); !(v = h.next()).done;) if ((y = o(h, b, v.value, n)) === s || y === f) return y;
  }).BREAK = s, n.RETURN = f;
}, function (t, n, e) {
  var r = e(2);
