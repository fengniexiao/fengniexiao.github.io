...
webpackJsonpL2Dwidget([0], {
  76: function _(t, e, i) {
    ...
    function L(t) {
      ...
      var e = n.currCanvas.getBoundingClientRect(),
        ...
        s = A(o.x - e.left),
        a = I(o.y - e.top);
      l.cDefine.DEBUG_MOUSE_LOG && console.log("modelTapEvent onMouseDown device( x:" + t.clientX + " y:" + t.clientY + " ) view( x:" + s + " y:" + a + ")"), i, r, p.L2Dwidget.emit("tap", t), c.tapEvent(s, a);
    }
    function M() {
      P && (P = !1), d.setPoint(0, 0);
    }
    function E(t) {
      if ("mousedown" == t.type) L(t);else if ("mousemove" == t.type) !function (t) {
        P = !0;
        var e = n.currCanvas.getBoundingClientRect(),
          i = w(t.clientX - e.left),
          r = D(t.clientY - e.top),
          ...
          s = A(o.x - e.left),
          a = I(o.y - e.top);
        l.cDefine.DEBUG_MOUSE_LOG && console.log("modelTurnHead onMouseMove device( x:" + t.clientX + " y:" + t.clientY + " ) view( x:" + s + " y:" + a + ")"), i, r, d.setPoint(s, a);
      }(t);else if ("mouseup" == t.type) {
    ...
    function x(t) {
      ...
      "touchstart" == t.type ? 1 == t.touches.length && L(e) : "touchmove" == t.type ? function (t) {
        var e = n.currCanvas.getBoundingClientRect(),
          ...
          s = A(o.x - e.left),
          a = I(o.y - e.top);
        l.cDefine.DEBUG_MOUSE_LOG && console.log("followPointer onMouseMove device( x:" + t.clientX + " y:" + t.clientY + " ) view( x:" + s + " y:" + a + ")"), P && (i, r, d.setPoint(s, a));
      }(e) : "touchend" == t.type && M();
    }
    function A(t) {
    ...
    e.theRealInit = function () {
      ...
      var t = n.currCanvas.getBoundingClientRect(),
        ...
        $ = -e,
        P = e;
      (y = new a.L2DViewMatrix()).setScreenRect(i, r, $, P), y.setMaxScreenRect(l.cDefine.VIEW_LOGICAL_MAX_LEFT, l.cDefine.VIEW_LOGICAL_MAX_RIGHT, l.cDefine.VIEW_LOGICAL_MAX_BOTTOM, l.cDefine.VIEW_LOGICAL_MAX_TOP), S = u["default"].mobile() && o.config.mobile.scale || o.config.model.scale, y.adjustScale(0, 0, S);
      var S;
      (m = new a.L2DMatrix44()).multScale(1, t.width / t.height), (T = new a.L2DMatrix44()).multTranslate(-t.width / 2, -t.height / 2), T.multScale(2 / t.width, -2 / t.height), s.Live2D.setGL(n.currWebGL), n.currWebGL.clearColor(0, 0, 0, 0), v = o.config.model.jsonPath, c.reloadFlg = !0, c.count++, c.changeModel(n.currWebGL, v);
      var v;
      g || (g = !0, function t() {
        !function () {
          h.MatrixStack.reset(), h.MatrixStack.loadIdentity(), d.update(), c.setDrag(d.getX(), d.getY()), n.currWebGL.clear(n.currWebGL.COLOR_BUFFER_BIT), h.MatrixStack.multMatrix(m.getArray()), h.MatrixStack.multMatrix(y.getArray()), h.MatrixStack.push();
  ...
  77: function _(t, e, i) {
    ...
    (function (t) {
      ...
      r._$0s = 1, r._$4s = 2, r._$42 = 0, r._$62 = function (t, e) {
        try {
          if (e instanceof ArrayBuffer && (e = new DataView(e)), !(e instanceof DataView)) throw new ht("_$SS#loadModel(b) / b _$x be DataView or ArrayBuffer");
          var i,
            o = new Pt(e),
            n = o._$ST(),
            s = o._$ST(),
          ...
          if (i = o._$ST(), o._$gr(i), i > G._$T7) {
            t._$NP |= r._$4s;
            throw new ht("_$gi _$C _$li , _$n0 _$_ version _$li ( SDK : " + G._$T7 + " < _$f0 : " + i + " )@_$SS#loadModel()\n");
          }
          var h = o._$nP();
          if (i >= G._$s7) {
            var l = o._$9T(),
        ...
        "number" != typeof t && (t = this._$5S.getParamIndex(l.getID(t))), arguments.length < 3 && (i = 1), this._$5S.setParamFloat(t, this._$5S.getParamFloat(t) * (1 - i) + e * i);
      }, r.prototype.addToParamFloat = function (t, e, i) {
        "number" != typeof t && (t = this._$5S.getParamIndex(l.getID(t))), arguments.length < 3 && (i = 1), this._$5S.setParamFloat(t, this._$5S.getParamFloat(t) + e * i);
      }, r.prototype.multParamFloat = function (t, e, i) {
        "number" != typeof t && (t = this._$5S.getParamIndex(l.getID(t))), arguments.length < 3 && (i = 1), this._$5S.setParamFloat(t, this._$5S.getParamFloat(t) * (1 + (e - 1) * i));
        ...
        if (0 != i) {
          if (1 == t.length) {
            ...
            o < 0 && (console.log("No _$wi _$q0/ _$U default[%s]", t[0]), o = 0, n = 1, this.loadParam(), this.setParamFloat(t[o], n), this.saveParam());
            for ($ = 0; $ < t.length; $++) {
              p = e[$];
              if (o == $) this.setPartsOpacity(p, n);else {
                var h,
                  l = this.getPartsOpacity(p);
                (1 - (h = n < .5 ? -.5 * n / .5 + 1 : .5 * (1 - n) / .5)) * (1 - n) > .15 && (h = 1 - .15 / (1 - n)), l > h && (l = h), this.setPartsOpacity(p, l);
              }
            }
          }
        } else for (var $ = 0; $ < t.length; $++) {
          var u = t[$],
            p = e[$],
        ...
        return "number" != typeof t && (t = this._$5S.getPartsDataIndex(h.getID(t))), t < 0 ? 0 : this._$5S.getPartsOpacity(t);
      ...
      function o(t) {
        if (!i) {
          ...
          var e = new E();
          (e = new E()).r = 0, e.g = 0, e.b = 0, e.a = 1, this.CHANNEL_COLORS.push(e), (e = new E()).r = 1, e.g = 0, e.b = 0, e.a = 0, this.CHANNEL_COLORS.push(e), (e = new E()).r = 0, e.g = 1, e.b = 0, e.a = 0, this.CHANNEL_COLORS.push(e), (e = new E()).r = 0, e.g = 0, e.b = 1, e.a = 0, this.CHANNEL_COLORS.push(e);
          for (var r = 0; r < this.CHANNEL_COLORS.length; r++) this.dp_webgl.setChannelFlagAsColor(r, this.CHANNEL_COLORS[r]);
        }
      }
      o.CHANNEL_COUNT = 4, o.RENDER_TEXTURE_USE_MIPMAP = !1, o.NOT_USED_FRAME = -100, o.prototype._$L7 = function () {
        ...
        if (i > 0) {
          var n = e.gl.getParameter(e.gl.FRAMEBUFFER_BINDING),
            s = new Array(4);
          s[0] = 0, s[1] = 0, s[2] = e.gl.canvas.width, s[3] = e.gl.canvas.height, e.gl.viewport(0, 0, at.clippingMaskBufferSize, at.clippingMaskBufferSize), this.setupLayoutBounds(i), e.gl.bindFramebuffer(e.gl.FRAMEBUFFER, at.frameBuffers[this.curFrameNo].framebuffer), e.gl.clearColor(0, 0, 0, 0), e.gl.clear(e.gl.COLOR_BUFFER_BIT);
        ...
        for (var e = 0; e < this.clipContextList.length; e++) {
          ...
          if (r == t.length) {
            for (var o = 0, n = 0; n < r; n++) for (var s = i.clipIDList[n], a = 0; a < r; a++) if (t[a] == s) {
              o++;
              break;
            }
            if (o == r) return i;
        ...
        for (var i = t._$Ri.getModelImpl().getCanvasWidth(), r = t._$Ri.getModelImpl().getCanvasHeight(), o = i > r ? i : r, n = o, s = o, a = 0, _ = 0, h = e.clippedDrawContextList.length, l = 0; l < h; l++) {
          var $ = e.clippedDrawContextList[l].drawDataIndex,
            u = t._$C2($);
          if (u._$yo()) {
            for (var p = u.getTransformedPoints(), c = p.length, f = [], g = [], d = 0, y = B._$i2; y < c; y += B._$No) f[d] = p[y], g[d] = p[y + 1], d++;
        ...
        for (var r = 0, n = 0; n < o.CHANNEL_COUNT; n++) {
          var s = e + (n < i ? 1 : 0);
          if (0 == s) ;else if (1 == s) {
            ($ = this.clipContextList[r++]).layoutChannelNo = n, $.layoutBounds.x = 0, $.layoutBounds.y = 0, $.layoutBounds.width = 1, $.layoutBounds.height = 1;
          } else if (2 == s) for (var _ = 0; _ < s; _++) {
            var h = 0;
            l = ~~(l = _ % 2);
            ($ = this.clipContextList[r++]).layoutChannelNo = n, $.layoutBounds.x = .5 * l, $.layoutBounds.y = 0, $.layoutBounds.width = .5, $.layoutBounds.height = 1;
          } else if (s <= 4) for (_ = 0; _ < s; _++) {
            l = ~~(l = _ % 2), h = ~~(h = _ / 2);
            ($ = this.clipContextList[r++]).layoutChannelNo = n, $.layoutBounds.x = .5 * l, $.layoutBounds.y = .5 * h, $.layoutBounds.width = .5, $.layoutBounds.height = .5;
          } else if (s <= 9) for (_ = 0; _ < s; _++) {
            var l;
            l = ~~(l = _ % 3), h = ~~(h = _ / 3);
            var $;
            ($ = this.clipContextList[r++]).layoutChannelNo = n, $.layoutBounds.x = l / 3, $.layoutBounds.y = h / 3, $.layoutBounds.width = 1 / 3, $.layoutBounds.height = 1 / 3;
      ...
      function s() {
        i || (this._$dP = null, this._$eo = null, this._$V0 = null, this._$dP = 1e3, this._$eo = 1e3, this._$V0 = 1, this._$a0());
      }
      ...
      function u() {
        i || (this.p1 = new p(), this.p2 = new p(), this._$Fo = 0, this._$Db = 0, this._$L2 = 0, this._$M2 = 0, this._$ks = 0, this._$9b = 0, this._$iP = 0, this._$iT = 0, this._$lL = new Array(), this._$qP = new Array(), this.setup(.3, .5, .1));
      }
      u.prototype.setup = function (t, e, i) {
        ...
        this.p2.fx = r + $ + p, this.p2.fy = o + u + c, this.p2.ax = this.p2.fx / this.p2._$p, this.p2.ay = this.p2.fy / this.p2._$p, this.p2.vx += this.p2.ax * e, this.p2.vy += this.p2.ay * e, this.p2.x += this.p2.vx * e, this.p2.y += this.p2.vy * e;
        var f = Math.sqrt((this.p1.x - this.p2.x) * (this.p1.x - this.p2.x) + (this.p1.y - this.p2.y) * (this.p1.y - this.p2.y));
        this.p2.x = this.p1.x + this._$Fo * (this.p2.x - this.p1.x) / f, this.p2.y = this.p1.y + this._$Fo * (this.p2.y - this.p1.y) / f, this.p2.vx = (this.p2.x - this.p2._$s0) * i, this.p2.vy = (this.p2.y - this.p2._$70) * i, this.p2._$xT();
      };
      function p() {
      ...
      }, u.Src = function () {}, u.Src.SRC_TO_X = "SRC_TO_X", u.Src.SRC_TO_Y = "SRC_TO_Y", u.Src.SRC_TO_G_ANGLE = "SRC_TO_G_ANGLE", u.Target = function () {}, u.Target.TARGET_FROM_ANGLE = "TARGET_FROM_ANGLE", u.Target.TARGET_FROM_ANGLE_V = "TARGET_FROM_ANGLE_V";
      function y() {
        i || (this._$fL = 0, this._$gL = 0, this._$B0 = 1, this._$z0 = 1, this._$qT = 0, this.reflectX = !1, this.reflectY = !1);
      }
      ...
      T._$ni = function (t, e, i, r, o, n, s, a, _) {
        ...
        var l,
          $ = ((t - i) * n - (e - r) * o) / h;
        return l = 0 != o ? (t - i - $ * s) / o : (e - r - $ * a) / n, isNaN(l) && (l = (t - i - $ * s) / o, isNaN(l) && (l = (e - r - $ * a) / n), isNaN(l) && (console.log("a is NaN @UtVector#_$ni() "), console.log("v1x : " + o), console.log("v1x != 0 ? " + (0 != o)))), null == _ ? new Array(l, $) : (_[0] = l, _[1] = $, _);
      };
      function P() {
        i || (this.x = null, this.y = null, this.width = null, this.height = null);
      }
      ...
      S._$Z2 = function (t, e, i, r) {
        ...
        if (3 == o) {
          var p = r[n[0]],
            ...
            T = r[n[7]],
            P = ($ = s[0], u = s[1], s[2]);
          return (S = (a = p + (c - p) * $ | 0) + ((_ = f + (g - f) * $ | 0) - a) * u | 0) + (((h = d + (y - d) * $ | 0) + ((l = m + (T - m) * $ | 0) - h) * u | 0) - S) * P | 0;
        }
        if (4 == o) {
          var S,
            v = r[n[0]],
          ...
          return (S = (a = (p = v + (L - v) * $ | 0) + ((c = M + (E - M) * $ | 0) - p) * u | 0) + ((_ = (f = x + (A - x) * $ | 0) + ((g = I + (w - I) * $ | 0) - f) * u | 0) - a) * P | 0) + (((h = (d = D + (O - D) * $ | 0) + ((y = b + (R - b) * $ | 0) - d) * u | 0) + ((l = (m = F + (C - F) * $ | 0) + ((T = N + (B - N) * $ | 0) - m) * u | 0) - h) * P | 0) - S) * G | 0;
        }
        ...
        if (3 == o) {
          var u = r[n[0]],
            ...
            m = r[n[7]],
            T = ($ = s[0], s[1]);
          return (1 - (N = s[2])) * ((1 - T) * (u + (p - u) * $) + T * (c + (f - c) * $)) + N * ((1 - T) * (g + (d - g) * $) + T * (y + (m - y) * $));
        }
        if (4 == o) {
          var P = r[n[0]],
            S = r[n[1]],
            ...
            N = ($ = s[0], T = s[1], s[2]),
            B = s[3];
          return (1 - B) * ((1 - N) * ((1 - T) * (P + (S - P) * $) + T * (v + (L - v) * $)) + N * ((1 - T) * (M + (E - M) * $) + T * (x + (A - x) * $))) + B * ((1 - N) * ((1 - T) * (I + (w - I) * $) + T * (D + (O - D) * $)) + N * ((1 - T) * (b + (R - b) * $) + T * (F + (C - F) * $)));
        }
        ...
        if (_ <= 0) {
          var p = o[h[0]];
          if (2 == a && 0 == s) A._$jT(p, 0, n, 0, $);else for (var c = 0; c < $;) n[u] = p[c++], n[u + 1] = p[c++], u += a;
        } else if (1 == _) {
          p = o[h[0]];
          var f = o[h[1]],
            g = 1 - (m = l[0]);
          ...
          var d = o[h[2]],
            ...
            S = b * g,
            v = b * m;
          for (c = 0; c < $;) n[u] = T * p[c] + P * f[c] + S * d[c] + v * y[c], ++c, n[u + 1] = T * p[c] + P * f[c] + S * d[c] + v * y[c], ++c, u += a;
        } else if (3 == _) {
          var L = o[h[0]],
            M = o[h[1]],
            E = o[h[2]],
            ...
            U = st * b * g,
            Y = st * b * m;
          for (c = 0; c < $;) n[u] = R * L[c] + F * M[c] + C * E[c] + N * x[c] + B * I[c] + G * w[c] + U * D[c] + Y * O[c], ++c, n[u + 1] = R * L[c] + F * M[c] + C * E[c] + N * x[c] + B * I[c] + G * w[c] + U * D[c] + Y * O[c], ++c, u += a;
        } else if (4 == _) {
          var k,
            V,
            X = o[h[0]],
            ...
            vt = at * st * b * g,
            Lt = at * st * b * m;
          for (c = 0; c < $;) n[u] = ht * X[c] + lt * z[c] + $t * H[c] + ut * W[c] + pt * j[c] + ct * q[c] + ft * J[c] + gt * Q[c] + dt * Z[c] + yt * K[c] + mt * tt[c] + Tt * et[c] + Pt * it[c] + St * rt[c] + vt * ot[c] + Lt * nt[c], ++c, n[u + 1] = ht * X[c] + lt * z[c] + $t * H[c] + ut * W[c] + pt * j[c] + ct * q[c] + ft * J[c] + gt * Q[c] + dt * Z[c] + yt * K[c] + mt * tt[c] + Tt * et[c] + Pt * it[c] + St * rt[c] + vt * ot[c] + Lt * nt[c], ++c, u += a;
        } else {
      ...
      function L() {
        i || (this._$gP = null, this._$dr = null, this._$GS = null, this._$qb = null, this._$Lb = null, this._$mS = null, this.clipID = null, this.clipIDList = new Array());
      }
      L._$ur = -2, L._$ES = 500, L._$wb = 2, L._$8S = 3, L._$52 = L._$ES, L._$R2 = L._$ES, L._$or = function () {
        ...
        if (e._$IS[0] = !1, e._$Us = S._$Z2(t, this._$GS, e._$IS, this._$Lb), at._$Zs) ;else if (e._$IS[0]) return;
      ...
      }, L.prototype.preDraw = function (t, e, i) {}, L.prototype.draw = function (t, e, i) {}, L.prototype.getType = function () {}, L.prototype._$B2 = function (t, e, i) {};
      function M() {
        i || (this._$Eb = M._$ps, this._$lT = 1, this._$C0 = 1, this._$tT = 1, this._$WL = 1, this.culling = !1, this.matrix4x4 = new Float32Array(16), this.premultipliedAlpha = !1, this.anisotropy = 0, this.clippingProcess = M.CLIPPING_PROCESS_NONE, this.clipBufPre_clipContextMask = null, this.clipBufPre_clipContextDraw = null, this.CHANNEL_COLORS = new Array());
      }
      M._$ps = 32, M.CLIPPING_PROCESS_NONE = 0, M.CLIPPING_PROCESS_OVERWRITE_ALPHA = 1, M.CLIPPING_PROCESS_MULTIPLY_ALPHA = 2, M.CLIPPING_PROCESS_DRAW = 3, M.CLIPPING_PROCESS_CLEAR_ALPHA = 4, M.prototype.setChannelFlagAsColor = function (t, e) {
        this.CHANNEL_COLORS[t] = e;
      }, M.prototype.getChannelFlagAsColor = function (t) {
        return this.CHANNEL_COLORS[t];
      }, M.prototype._$ZT = function () {}, M.prototype._$Uo = function (t, e, i, r, o, n, s) {}, M.prototype._$Rs = function () {
        return -1;
      ...
      }, x.prototype.init = function (t) {}, x.prototype._$Nr = function (t, e) {}, x.prototype.interpolateOpacity = function (t, e, i, r) {
        null == this._$mS ? i.setInterpolatedOpacity(1) : i.setInterpolatedOpacity(S._$br(t, e, r, this._$mS));
      }, x.prototype._$2b = function (t, e) {}, x.prototype._$nb = function (t, e, i, r, o, n, s) {}, x.prototype.getType = function () {}, x.prototype._$gs = function (t) {
        this._$dr = t;
      ...
      function I() {
        i || (this._$VP = 0, this._$wL = null, this._$GP = null, this._$8o = I._$ds, this._$2r = -1, this._$O2 = 0, this._$ri = 0);
      }
      ...
      w.startsWith = function (t, e, i) {
        ...
        for (var o = e; o < r; o++) if (w.getChar(t, o) != i.charAt(o - e)) return !1;
        return !0;
      ...
      D.prototype._$zP = function () {
        ...
        for (var i, r, o = this._$Ob.length, n = t._$v2(), s = 0, a = 0; a < o; a++) {
          var _ = this._$Ob[a];
          if ((i = _.getParamIndex(n)) == I._$ds && (i = t.getParamIndex(_.getParamID()), _._$Pb(i, n)), i < 0) throw new Exception("err 23242 : " + _.getParamID());
          ...
          var l,
            ...
            p = -1,
            c = 0;
          if (r < 1) ;else if (1 == r) (l = u[0]) - B._$J < h && h < l + B._$J ? (p = 0, c = 0) : (p = 0, e[0] = !0);else if (h < (l = u[0]) - B._$J) p = 0, e[0] = !0;else if (h < l + B._$J) p = 0;else {
      ...
      function R() {
        i || (this._$7 = 1, this._$f = 0, this._$H = 0, this._$g = 1, this._$k = 0, this._$w = 0, this._$hi = STATE_IDENTITY, this._$Z = _$pS);
      }
      R._$kS = -1, R._$pS = 0, R._$hb = 1, R.STATE_IDENTITY = 0, R._$gb = 1, R._$fo = 2, R._$go = 4, R.prototype.transform = function (t, e, i) {
        var r,
          o,
          n,
          s,
        ...
        switch (this._$hi) {
          ...
          case R._$go:
            ...
            return;
          case R._$fo | R._$gb:
            for (r = this._$7, n = this._$k, a = this._$g, _ = this._$w; --i >= 0;) e[l++] = r * t[h++] + n, e[l++] = a * t[h++] + _;
            return;
          case R._$fo:
        ...
        var e = t[0],
          ...
          n = Math.sqrt(e * e + r * r),
          s = e * o - i * r;
        0 == n ? at._$so && console.log("affine._$RT() / rt==0") : (t[0] = n, t[1] = s / n, t[2] = (r * o + e * i) / s, t[3] = Math.atan2(r, e));
      ...
      function F() {
        i || (s.prototype.constructor.call(this), this.motions = new Array(), this._$7r = null, this._$7r = F._$Co++, this._$D0 = 30, this._$yT = 0, this._$E = !0, this.loopFadeIn = !0, this._$AS = -1, _$a0());
      }
      F.prototype = new s(), F._$cs = "VISIBLE:", F._$ar = "LAYOUT:", F._$Co = 0, F._$D2 = [], F._$1T = 1, F.loadMotion = function (t) {
        var e = new F(),
          i = [0],
          r = t.length;
        e._$yT = 0;
          ...
          if ("\n" != n && "\r" != n) if ("#" != n) {
            if ("$" != n) {
              if ("a" <= n && n <= "z" || "A" <= n && n <= "Z" || "_" == n) {
                ...
                if (l >= 0) {
                  var s = new N();
                  w.startsWith(t, h, F._$cs) ? (s._$RP = N._$hs, s._$4P = new String(t, h, l - h)) : w.startsWith(t, h, F._$ar) ? (s._$4P = new String(t, h + 7, l - h - 7), w.startsWith(t, h + 7, "ANCHOR_X") ? s._$RP = N._$xs : w.startsWith(t, h + 7, "ANCHOR_Y") ? s._$RP = N._$us : w.startsWith(t, h + 7, "SCALE_X") ? s._$RP = N._$qs : w.startsWith(t, h + 7, "SCALE_Y") ? s._$RP = N._$Ys : w.startsWith(t, h + 7, "X") ? s._$RP = N._$ws : w.startsWith(t, h + 7, "Y") && (s._$RP = N._$Ns)) : (s._$RP = N._$Fr, s._$4P = new String(t, h, l - h)), e.motions.push(s);
                  var a = 0;
              ...
              var $ = !1;
              if (l >= 0) for (l == h + 4 && "f" == t[h + 1] && "p" == t[h + 2] && "s" == t[h + 3] && ($ = !0), o = l + 1; o < r && "\r" != (n = 255 & t[o]) && "\n" != n; ++o) if ("," != n && " " != n && "\t" != n) {
        ...
        for (var o = (e - r._$z2) * this._$D0 / 1e3, n = 0 | o, s = o - n, a = 0; a < this.motions.length; a++) {
          ...
          if (_._$RP == N._$hs) {
            ...
            t.setParamFloat(l, $);
          } else if (N._$ws <= _._$RP && _._$RP <= N._$Ys) ;else {
      ...
      function B() {}
      B._$Ms = 1, B._$Qs = 2, B._$i2 = 0, B._$No = 2, B._$do = B._$Ms, B._$Ls = !0, B._$1r = 5, B._$Qb = 65, B._$J = 1e-4, B._$FT = .001, B._$Ss = 3;
      function G() {}
      G._$o7 = 6, G._$S7 = 7, G._$s7 = 8, G._$77 = 9, G.LIVE2D_FORMAT_VERSION_V2_10_SDK2 = 10, G.LIVE2D_FORMAT_VERSION_V2_11_SDK2_1 = 11, G._$T7 = G.LIVE2D_FORMAT_VERSION_V2_11_SDK2_1, G._$Is = -2004318072, G._$h0 = 0, G._$4L = 23, G._$7P = 33, G._$uT = function (t) {
      ...
      function U(t) {
        i || (this._$QT = !0, this._$co = -1, this._$qo = 0, this._$pb = new Array(U._$is), this._$_2 = new Float32Array(U._$is), this._$vr = new Float32Array(U._$is), this._$Rr = new Float32Array(U._$is), this._$Or = new Float32Array(U._$is), this._$fs = new Float32Array(U._$is), this._$Js = new Array(U._$is), this._$3S = new Array(), this._$aS = new Array(), this._$Bo = null, this._$F2 = new Array(), this._$db = new Array(), this._$8b = new Array(), this._$Hr = new Array(), this._$Ws = null, this._$Vs = null, this._$Er = null, this._$Es = new Int16Array(B._$Qb), this._$ZP = new Float32Array(2 * B._$1r), this._$Ri = t, this._$b0 = U._$HP++, this.clipManager = null, this.dp_webgl = null);
      }
      U._$HP = 0, U._$_0 = !0, U._$V2 = -1, U._$W0 = -1, U._$jr = !1, U._$ZS = !0, U._$tr = -1e6, U._$lr = 1e6, U._$is = 32, U._$e = !1, U.prototype.getDrawDataIndex = function (t) {
        ...
        for (var g = r.length, d = dt._$2o();;) {
          ...
          for (s = 0; s < g; ++s) {
            ...
            if (null != m) {
              ...
              (null == T || T == d || this.getBaseDataIndex(T) >= 0) && (this._$3S.push(m), this._$db.push(n[s]), r[s] = null, y = !0);
            }
          }
          if (!y) break;
        }
        ...
        U._$e && a.start("_$zL");
        for (var t = this._$_2.length, e = 0; e < t; e++) this._$_2[e] != this._$vr[e] && (this._$Js[e] = U._$ZS, this._$vr[e] = this._$_2[e]);
        ...
        for (var $ = null, u = 0; u < r; ++u) {
          ...
          try {
            ...
            try {
              ...
              console.log("_$li :: %s / %s        @@_$fS\n", t.toString(), p.getDrawDataID().toString()), g = Math.floor(p._$zS(this, c) - o);
              continue;
            }
        ...
        return this._$pb[this._$qo] = t, this._$_2[this._$qo] = e, this._$vr[this._$qo] = e, this._$Rr[this._$qo] = i, this._$Or[this._$qo] = r, this._$Js[this._$qo] = U._$ZS, this._$qo++;
      ...
      Y._$0T = function (t) {
        ...
        for (var e, i = t.length(), r = new Int8Array(i), o = new _$Xs(new _$kb(t), 8192), n = 0; (e = o.read(r, n, i - n)) > 0;) n += e;
        return r;
      }, Y._$C = function (t) {
        var e = null,
          i = null;
        try {
          ...
          for (var r, o = new Int8Array(1e3); (r = e.read(o)) > 0;) i.write(o, 0, r);
          return i._$TS();
        } finally {
      ...
      function k() {
        i || (this._$12 = null, this._$bb = null, this._$_L = null, this._$jo = null, this._$iL = null, this._$0L = null, this._$Br = null, this._$Dr = null, this._$Cb = null, this._$mr = null, this._$_L = V.STATE_FIRST, this._$Br = 4e3, this._$Dr = 100, this._$Cb = 50, this._$mr = 150, this._$jo = !0, this._$iL = "PARAM_EYE_L_OPEN", this._$0L = "PARAM_EYE_R_OPEN");
      }
      k.prototype._$T2 = function () {
        ...
        switch (this._$_L) {
          ...
          case STATE_CLOSED:
            ...
            break;
          case STATE_OPENING:
            (r = (i - this._$bb) / this._$mr) >= 1 && (r = 1, this._$_L = V.STATE_INTERVAL, this._$12 = this._$T2()), e = r;
            break;
          case STATE_INTERVAL:
      ...
      function X() {
        i || (M.prototype.constructor.call(this), this._$sb = new Int32Array(X._$As), this._$U2 = new Array(), this.transform = null, this.gl = null, null == X._$NT && (X._$NT = X._$9r(256), X._$vS = X._$9r(256), X._$no = X._$vb(256)));
      }
      X.prototype = new M(), X._$As = 32, X._$Gr = !1, X._$NT = null, X._$vS = null, X._$no = null, X._$9r = function (t) {
        ...
        return null == t || t._$yL() < e.length ? ((t = X._$9r(2 * e.length)).put(e), t._$oT(0)) : (t.clear(), t.put(e), t._$oT(0)), t;
      }, X._$mb = function (t, e) {
        return null == t || t._$yL() < e.length ? ((t = X._$vb(2 * e.length)).put(e), t._$oT(0)) : (t.clear(), t.put(e), t._$oT(0)), t;
      }, X._$Hs = function () {
        return X._$Gr;
      }, X._$as = function (t) {
        X._$Gr = t;
      ...
      z.prototype = new x(), z._$Xo = new Float32Array(2), z._$io = new Float32Array(2), z._$0o = new Float32Array(2), z._$Lo = new Float32Array(2), z._$To = new Float32Array(2), z._$Po = new Float32Array(2), z._$gT = new Array(), z.prototype._$zP = function () {
        this._$GS = new D(), this._$GS._$zP(), this._$Y0 = new Array();
      }, z.prototype.getType = function () {
        return x._$c2;
      }, z.prototype._$F0 = function (t) {
        x.prototype._$F0.call(this, t), this._$GS = t._$nP(), this._$Y0 = t._$nP(), x.prototype.readV2_opacity.call(this, t);
        ...
        if (this._$GS._$Ur(t)) {
          ...
          if (this._$GS._$zr(n, s, o), o <= 0) {
            ...
            var _ = this._$Y0[n[1]],
              h = s[0];
            i._$Yr._$fL = a._$fL + (_._$fL - a._$fL) * h, i._$Yr._$gL = a._$gL + (_._$gL - a._$gL) * h, i._$Yr._$B0 = a._$B0 + (_._$B0 - a._$B0) * h, i._$Yr._$z0 = a._$z0 + (_._$z0 - a._$z0) * h, i._$Yr._$qT = a._$qT + (_._$qT - a._$qT) * h;
          } else if (2 == o) {
            ...
            i._$Yr._$fL = p + (c - p) * u, p = a._$gL + (_._$gL - a._$gL) * h, c = l._$gL + ($._$gL - l._$gL) * h, i._$Yr._$gL = p + (c - p) * u, p = a._$B0 + (_._$B0 - a._$B0) * h, c = l._$B0 + ($._$B0 - l._$B0) * h, i._$Yr._$B0 = p + (c - p) * u, p = a._$z0 + (_._$z0 - a._$z0) * h, c = l._$z0 + ($._$z0 - l._$z0) * h, i._$Yr._$z0 = p + (c - p) * u, p = a._$qT + (_._$qT - a._$qT) * h, c = l._$qT + ($._$qT - l._$qT) * h, i._$Yr._$qT = p + (c - p) * u;
          } else if (3 == o) {
            var f = this._$Y0[n[0]],
              g = this._$Y0[n[1]],
              d = this._$Y0[n[2]],
            ...
            var it = 0,
              ...
              nt = 0,
              st = 0;
            for (et = 0; et < j; et++) it += q[et] * tt[et]._$fL, rt += q[et] * tt[et]._$gL, ot += q[et] * tt[et]._$B0, nt += q[et] * tt[et]._$z0, st += q[et] * tt[et]._$qT;
        ...
        if (i._$hS(!0), this._$32()) {
          ...
          if (i._$8r == x._$ur && (i._$8r = t.getBaseDataIndex(r)), i._$8r < 0) at._$so && a._$li("_$L _$0P _$G :: %s", r), i._$hS(!1);else {
            ...
            if (null != o) {
              ...
              var l = vt._$92(_, h);
              o._$nb(t, n, s, s, 1, 0, 2), i._$Wr._$fL = s[0], i._$Wr._$gL = s[1], i._$Wr._$B0 = i._$Yr._$B0, i._$Wr._$z0 = i._$Yr._$z0, i._$Wr._$qT = i._$Yr._$qT - l * vt._$NS;
              var $ = n.getTotalScale();
        ...
        this != e._$GT() && console.log("### assert!! ### ");
        for (var a, _, h = e, l = null != h._$Wr ? h._$Wr : h._$Yr, $ = Math.sin(vt._$bS * l._$qT), u = Math.cos(vt._$bS * l._$qT), p = h.getTotalScale(), c = l.reflectX ? -1 : 1, f = l.reflectY ? -1 : 1, g = u * p * c, d = -$ * p * f, y = $ * p * c, m = u * p * f, T = l._$fL, P = l._$gL, S = o * s, v = n; v < S; v += s) a = i[v], _ = i[v + 1], r[v] = g * a + d * _ + T, r[v + 1] = y * a + m * _ + P;
        ...
        for (var a = z._$To, _ = z._$Po, h = 1, l = 0; l < 10; l++) {
          if (_[0] = r[0] + h * o[0], _[1] = r[1] + h * o[1], e._$nb(t, i, _, a, 1, 0, 2), a[0] -= s[0], a[1] -= s[1], 0 != a[0] || 0 != a[1]) return n[0] = a[0], void (n[1] = a[1]);
          if (_[0] = r[0] - h * o[0], _[1] = r[1] - h * o[1], e._$nb(t, i, _, a, 1, 0, 2), a[0] -= s[0], a[1] -= s[1], 0 != a[0] || 0 != a[1]) return a[0] = -a[0], a[0] = -a[0], n[0] = a[0], void (n[1] = a[1]);
          h *= .1;
        }
      ...
      H.prototype = new st();
      function W() {
        i || (L.prototype.constructor.call(this), this._$gP = null, this._$dr = null, this._$GS = null, this._$qb = null, this._$Lb = null, this._$mS = null);
      }
      W.prototype = new L(), W._$ur = -2, W._$ES = 500, W._$wb = 2, W._$8S = 3, W._$os = 4, W._$52 = W._$ES, W._$R2 = W._$ES, W._$Sb = function (t) {
        for (var e = t.length - 1; e >= 0; --e) {
          var i = t[e];
      ...
      function J() {
        i || (s.prototype.constructor.call(this), this.motions = new Array(), this._$o2 = null, this._$7r = J._$Co++, this._$D0 = 30, this._$yT = 0, this._$E = !1, this.loopFadeIn = !0, this._$rr = -1, this._$eP = 0);
      }
          ...
          if ("\n" != n && "\r" != n) if ("#" != n) {
            if ("$" != n) {
              if (97 <= s && s <= 122 || 65 <= s && s <= 90 || "_" == n) {
                ...
                if (u >= 0) {
                  var a = new N();
                  w.startsWith(t, $, J._$cs) ? (a._$RP = N._$hs, a._$4P = w.createString(t, $, u - $)) : w.startsWith(t, $, J._$ar) ? (a._$4P = w.createString(t, $ + 7, u - $ - 7), w.startsWith(t, $ + 7, "ANCHOR_X") ? a._$RP = N._$xs : w.startsWith(t, $ + 7, "ANCHOR_Y") ? a._$RP = N._$us : w.startsWith(t, $ + 7, "SCALE_X") ? a._$RP = N._$qs : w.startsWith(t, $ + 7, "SCALE_Y") ? a._$RP = N._$Ys : w.startsWith(t, $ + 7, "X") ? a._$RP = N._$ws : w.startsWith(t, $ + 7, "Y") && (a._$RP = N._$Ns)) : (a._$RP = N._$Fr, a._$4P = w.createString(t, $, u - $)), e.motions.push(a);
                  var _ = 0,
                    h = [];
                  for (o = u + 1; o < r && "\r" != (n = Q(t, o)) && "\n" != n; ++o) if ("," != n && " " != n && "\t" != n) {
                    c = w._$LS(t, r, o, i);
              ...
              var p = !1;
              if (u >= 0) for (u == $ + 4 && "f" == Q(t, $ + 1) && "p" == Q(t, $ + 2) && "s" == Q(t, $ + 3) && (p = !0), o = u + 1; o < r && "\r" != (n = Q(t, o)) && "\n" != n; ++o) if ("," != n && " " != n && "\t" != n) {
      ...
      Z.prototype = new x(), Z._$gT = new Array(), Z.prototype._$zP = function () {
        ...
        x.prototype._$F0.call(this, t), this._$A = t._$6L(), this._$o = t._$6L(), this._$GS = t._$nP(), this._$Eo = t._$nP(), x.prototype.readV2_opacity.call(this, t);
      }, Z.prototype.init = function (t) {
        var e = new K(this),
        ...
        if (i._$hS(!0), this._$32()) {
          ...
          if (i._$8r == x._$ur && (i._$8r = t.getBaseDataIndex(r)), i._$8r < 0) at._$so && a._$li("_$L _$0P _$G :: %s", r), i._$hS(!1);else {
            ...
            if (null != o && n._$yo()) {
              ...
              i.setTotalOpacity(_ * i.getInterpolatedOpacity()), o._$nb(t, n, i._$Cr, i._$hr, this._$VT(), 0, 2), i._$hS(!0);
            } else i._$hS(!1);
          }
        ...
        for (var h, l, $, u = r * n, p = 0, c = 0, f = 0, g = 0, d = 0, y = 0, m = !1, T = o; T < u; T += n) {
          ...
          if (v = e[T], S = (L = e[T + 1]) * _, (P = v * a) < 0 || S < 0 || a <= P || _ <= S) {
            var M = a + 1;
            if (!m) {
              m = !0, p = .25 * (s[2 * (0 + 0 * M)] + s[2 * (a + 0 * M)] + s[2 * (0 + _ * M)] + s[2 * (a + _ * M)]), c = .25 * (s[2 * (0 + 0 * M) + 1] + s[2 * (a + 0 * M) + 1] + s[2 * (0 + _ * M) + 1] + s[2 * (a + _ * M) + 1]);
              ...
              if (v <= 0) {
                if (L <= 0) {
                  var w = s[2 * (0 + 0 * M)],
                    ...
                    C = p - 2 * f - 2 * d,
                    N = c - 2 * g - 2 * y;
                  (B = .5 * (v - -2)) + (G = .5 * (L - -2)) <= 1 ? (i[T] = C + (R - C) * B + (O - C) * G, i[T + 1] = N + (F - N) * B + (b - N) * G) : (i[T] = w + (O - w) * (1 - B) + (R - w) * (1 - G), i[T + 1] = D + (b - D) * (1 - B) + (F - D) * (1 - G));
                } else if (L >= 1) {
                  R = s[2 * (0 + _ * M)], F = s[2 * (0 + _ * M) + 1], C = p - 2 * f + 1 * d, N = c - 2 * g + 1 * y, w = p + 3 * d, D = c + 3 * y, O = p - 2 * f + 3 * d, b = c - 2 * g + 3 * y;
                  (B = .5 * (v - -2)) + (G = .5 * (L - 1)) <= 1 ? (i[T] = C + (R - C) * B + (O - C) * G, i[T + 1] = N + (F - N) * B + (b - N) * G) : (i[T] = w + (O - w) * (1 - B) + (R - w) * (1 - G), i[T + 1] = D + (b - D) * (1 - B) + (F - D) * (1 - G));
                } else {
                  (k = 0 | S) == _ && (k = _ - 1);
                  var B = .5 * (v - -2),
                    G = S - k,
                    U = k / _,
                    Y = (k + 1) / _;
                  R = s[2 * (0 + k * M)], F = s[2 * (0 + k * M) + 1], w = s[2 * (0 + (k + 1) * M)], D = s[2 * (0 + (k + 1) * M) + 1], C = p - 2 * f + U * d, N = c - 2 * g + U * y, O = p - 2 * f + Y * d, b = c - 2 * g + Y * y;
                  B + G <= 1 ? (i[T] = C + (R - C) * B + (O - C) * G, i[T + 1] = N + (F - N) * B + (b - N) * G) : (i[T] = w + (O - w) * (1 - B) + (R - w) * (1 - G), i[T + 1] = D + (b - D) * (1 - B) + (F - D) * (1 - G));
                }
              } else if (1 <= v) {
                if (L <= 0) {
                  O = s[2 * (a + 0 * M)], b = s[2 * (a + 0 * M) + 1], w = p + 3 * f, D = c + 3 * g, C = p + 1 * f - 2 * d, N = c + 1 * g - 2 * y, R = p + 3 * f - 2 * d, F = c + 3 * g - 2 * y;
                  (B = .5 * (v - 1)) + (G = .5 * (L - -2)) <= 1 ? (i[T] = C + (R - C) * B + (O - C) * G, i[T + 1] = N + (F - N) * B + (b - N) * G) : (i[T] = w + (O - w) * (1 - B) + (R - w) * (1 - G), i[T + 1] = D + (b - D) * (1 - B) + (F - D) * (1 - G));
                } else if (L >= 1) {
                  C = s[2 * (a + _ * M)], N = s[2 * (a + _ * M) + 1], R = p + 3 * f + 1 * d, F = c + 3 * g + 1 * y, O = p + 1 * f + 3 * d, b = c + 1 * g + 3 * y, w = p + 3 * f + 3 * d, D = c + 3 * g + 3 * y;
                  (B = .5 * (v - 1)) + (G = .5 * (L - 1)) <= 1 ? (i[T] = C + (R - C) * B + (O - C) * G, i[T + 1] = N + (F - N) * B + (b - N) * G) : (i[T] = w + (O - w) * (1 - B) + (R - w) * (1 - G), i[T + 1] = D + (b - D) * (1 - B) + (F - D) * (1 - G));
                } else {
                  var k;
                  (k = 0 | S) == _ && (k = _ - 1);
                  B = .5 * (v - 1), G = S - k, U = k / _, Y = (k + 1) / _, C = s[2 * (a + k * M)], N = s[2 * (a + k * M) + 1], O = s[2 * (a + (k + 1) * M)], b = s[2 * (a + (k + 1) * M) + 1], R = p + 3 * f + U * d, F = c + 3 * g + U * y, w = p + 3 * f + Y * d, D = c + 3 * g + Y * y;
                  B + G <= 1 ? (i[T] = C + (R - C) * B + (O - C) * G, i[T + 1] = N + (F - N) * B + (b - N) * G) : (i[T] = w + (O - w) * (1 - B) + (R - w) * (1 - G), i[T + 1] = D + (b - D) * (1 - B) + (F - D) * (1 - G));
                }
              } else if (L <= 0) {
                (z = 0 | P) == a && (z = a - 1);
                ...
                var V = z / a,
                  X = (z + 1) / a;
                O = s[2 * (z + 0 * M)], b = s[2 * (z + 0 * M) + 1], w = s[2 * (z + 1 + 0 * M)], D = s[2 * (z + 1 + 0 * M) + 1], C = p + V * f - 2 * d, N = c + V * g - 2 * y, R = p + X * f - 2 * d, F = c + X * g - 2 * y;
                B + G <= 1 ? (i[T] = C + (R - C) * B + (O - C) * G, i[T + 1] = N + (F - N) * B + (b - N) * G) : (i[T] = w + (O - w) * (1 - B) + (R - w) * (1 - G), i[T + 1] = D + (b - D) * (1 - B) + (F - D) * (1 - G));
              } else if (L >= 1) {
                var z;
                (z = 0 | P) == a && (z = a - 1);
                B = P - z, G = .5 * (L - 1), V = z / a, X = (z + 1) / a, C = s[2 * (z + _ * M)], N = s[2 * (z + _ * M) + 1], R = s[2 * (z + 1 + _ * M)], F = s[2 * (z + 1 + _ * M) + 1], O = p + V * f + 3 * d, b = c + V * g + 3 * y, w = p + X * f + 3 * d, D = c + X * g + 3 * y;
                B + G <= 1 ? (i[T] = C + (R - C) * B + (O - C) * G, i[T + 1] = N + (F - N) * B + (b - N) * G) : (i[T] = w + (O - w) * (1 - B) + (R - w) * (1 - G), i[T + 1] = D + (b - D) * (1 - B) + (F - D) * (1 - G));
              } else t.err.printf("_$li calc : %.4f , %.4f          @@BDBoxGrid\n", v, L);
            } else i[T] = p + v * f + L * d, i[T + 1] = c + v * g + L * y;
          } else h = 2 * ((0 | P) + (0 | S) * (a + 1)), (l = P - (0 | P)) + ($ = S - (0 | S)) < 1 ? (i[T] = s[h] * (1 - l - $) + s[h + 2] * l + s[h + 2 * (a + 1)] * $, i[T + 1] = s[h + 1] * (1 - l - $) + s[h + 3] * l + s[h + 2 * (a + 1) + 1] * $) : (i[T] = s[h + 2 * (a + 1) + 2] * (l - 1 + $) + s[h + 2 * (a + 1)] * (1 - l) + s[h + 2] * (1 - $), i[T + 1] = s[h + 2 * (a + 1) + 3] * (l - 1 + $) + s[h + 2 * (a + 1) + 1] * (1 - l) + s[h + 3] * (1 - $));
        }
      }, Z.prototype.transformPoints_sdk1 = function (t, e, i, r, o, n, s) {
        for (var a, _, h, l, $, u, p, c = e, f = this._$o, g = this._$A, d = o * s, y = null != c._$hr ? c._$hr : c._$Cr, m = n; m < d; m += s) at._$ts ? (a = i[m], _ = i[m + 1], a < 0 ? a = 0 : a > 1 && (a = 1), _ < 0 ? _ = 0 : _ > 1 && (_ = 1), l = 0 | (_ *= g), (h = 0 | (a *= f)) > f - 1 && (h = f - 1), l > g - 1 && (l = g - 1), u = a - h, p = _ - l, $ = 2 * (h + l * (f + 1))) : (u = (a = i[m] * f) - (0 | a), p = (_ = i[m + 1] * g) - (0 | _), $ = 2 * ((0 | a) + (0 | _) * (f + 1))), u + p < 1 ? (r[m] = y[$] * (1 - u - p) + y[$ + 2] * u + y[$ + 2 * (f + 1)] * p, r[m + 1] = y[$ + 1] * (1 - u - p) + y[$ + 3] * u + y[$ + 2 * (f + 1) + 1] * p) : (r[m] = y[$ + 2 * (f + 1) + 2] * (u - 1 + p) + y[$ + 2 * (f + 1)] * (1 - u) + y[$ + 2] * (1 - p), r[m + 1] = y[$ + 2 * (f + 1) + 3] * (u - 1 + p) + y[$ + 2 * (f + 1) + 1] * (1 - u) + y[$ + 3] * (1 - p));
      ...
      ot.tr = new gt(), ot._$50 = new gt(), ot._$Ti = new Array(0, 0), ot._$Pi = new Array(0, 0), ot._$B = new Array(0, 0), ot.prototype._$lP = function (t, e, i, r) {
        ...
        try {
          ...
          for (var h = e.length, l = t.width, $ = t.height, u = this.context, p = this._$xP, c = this._$uP, f = this._$6r, g = this._$3r, d = ot.tr, y = ot._$Ti, m = ot._$Pi, P = ot._$B, S = 0; S < h; S += 3) {
            u.save();
            var v = e[S],
              L = e[S + 1],
              M = e[S + 2],
              ...
              w = p + f * i[2 * M],
              D = c + g * i[2 * M + 1];
            s && (s._$PS(E, x, P), E = P[0], x = P[1], s._$PS(A, I, P), A = P[0], I = P[1], s._$PS(w, D, P), w = P[0], D = P[1]);
            var O = l * r[2 * v],
              b = $ - $ * r[2 * v + 1],
              R = l * r[2 * L],
              F = $ - $ * r[2 * L + 1],
            ...
            var H = (m[0] - y[0]) / y[1],
              ...
              K = Math.ceil(j),
              tt = Math.ceil(J);
            d.identity(), d.translate(E, x), d.rotate(G), d.scale(1, m[1] / y[1]), d.shear(H, 0), d.scale(z, z), d.rotate(-B), d.translate(-O, -b), d.setContext(u);
            if (n || (n = 1.2), at.IGNORE_EXPAND && (n = 0), at.USE_CACHED_POLYGON_IMAGE) {
              ...
              if (et.gl_cacheImage = et.gl_cacheImage || {}, !et.gl_cacheImage[S]) {
                ...
                rt.translate(-Q, -Z), ot.clip(rt, d, n, k, O, b, R, F, C, N, E, x, A, I, w, D), rt.drawImage(t, 0, 0), et.gl_cacheImage[S] = {
                  cacheCanvas: it,
                  cacheContext: rt
                };
              }
              u.drawImage(et.gl_cacheImage[S].cacheCanvas, Q, Z);
            } else at.IGNORE_CLIP || ot.clip(u, d, n, k, O, b, R, F, C, N, E, x, A, I, w, D), at.USE_ADJUST_TRANSLATION && (W = 0, j = l, q = 0, J = $), u.drawImage(t, W, q, j - W, J - q, W, q, j - W, J - q);
            u.restore();
          }
        } catch (t) {
          a._$Rb(t);
        ...
        if (arguments.length < 7) a._$li("err : @LDGL.clip()");else if (arguments[1] instanceof gt) {
          var h = ot._$B,
            l = e,
            $ = arguments;
          if (t.beginPath(), l) {
      ...
      function st(t) {
        i || (this._$e0 = null, this._$IP = null, this._$JS = !1, this._$AT = !0, this._$e0 = t, this.totalScale = 1, this._$7s = 1, this.totalOpacity = 1);
      }
      ...
      function lt() {
        i || (W.prototype.constructor.call(this), this._$LP = -1, this._$d0 = 0, this._$Yo = 0, this._$JP = null, this._$5P = null, this._$BP = null, this._$Eo = null, this._$Qi = null, this._$6s = lt._$ms, this.culling = !0, this.gl_cacheImage = null, this.instanceNo = lt._$42++);
      }
      lt.prototype = new W(), lt._$42 = 0, lt._$Os = 30, lt._$ms = 0, lt._$ns = 1, lt._$_s = 2, lt._$gT = new Array(), lt.prototype._$_S = function (t) {
        this._$LP = t;
        ...
        if (this._$Eo = t._$nP(), this._$Qi = t._$nP(), t.getFormatVersion() >= G._$s7) {
          if (this._$JP = t._$6L(), 0 != this._$JP) {
            ...
            0 != (this._$JP & lt._$Os) ? this._$6s = (this._$JP & lt._$Os) >> 1 : this._$6s = lt._$ms, 0 != (32 & this._$JP) && (this.culling = !1);
          }
        } else this._$JP = 0;
        ...
        switch (B._$do) {
          default:
          case B._$Ms:
            if (B._$Ls) for (var o = this._$d0 - 1; o >= 0; --o) {
              var n = o << 1;
          ...
          case B._$Qs:
            for (o = this._$d0 - 1; o >= 0; --o) {
              ...
              var s = o * B._$No,
                a = this._$Qi[n],
                _ = this._$Qi[n + 1];
              e._$Cr[s] = a, e._$Cr[s + 1] = _, e._$Cr[s + 4] = 0, r && (e._$hr[s] = a, e._$hr[s + 1] = _, e._$hr[s + 4] = 0);
            }
        }
        return e;
      }, lt.prototype._$Nr = function (t, e) {
        var i = e;
        if (this != i._$GT() && console.log("### assert!! ### "), this._$GS._$Ur(t) && (W.prototype._$Nr.call(this, t, i), !i._$IS[0])) {
          var r = lt._$gT;
        ...
        try {
          ...
          if (!i && (W.prototype._$2b.call(this, t), this._$32())) {
            ...
            if (r._$8r == W._$ur && (r._$8r = t.getBaseDataIndex(o)), r._$8r < 0) at._$so && a._$li("_$L _$0P _$G :: %s", o);else {
      ...
      pt.prototype = new r(), pt.loadModel = function (t) {
        ...
        null == this.drawParamWebGL && a._$li("_$Yi for QT _$ki / _$XS() is _$6 _$ui!!"), this.drawParamWebGL.setTexture(t, e);
      }, pt.prototype.setTexture = function (t, e) {
        null == this.drawParamWebGL && a._$li("_$Yi for QT _$ki / _$XS() is _$6 _$ui!!"), this.drawParamWebGL.setTexture(t, e);
      ...
      ct.prototype._$tb = function () {
        ...
        for (var i = null, r = this.motions.length, o = 0; o < r; ++o) null != (i = this.motions[o]) && (i._$qS(i._$w0.getFadeOut()), this._$eb && a._$Ji("MotionQueueManager[size:%2d]->startMotion() / start _$K _$3 (m%d)\n", r, i._$sr));
        if (null == t) return -1;
        ...
        try {
          for (var e = !1, i = 0; i < this.motions.length; i++) {
            ...
            if (null != r) {
              var o = r._$w0;
              null != o ? (o.updateParam(t, r), e = !0, r.isFinished() && (this._$eb && a._$Ji("MotionQueueManager[size:%2d]->updateParam() / _$T0 _$w0 (m%d)\n", this.motions.length - 1, r._$sr), this.motions.splice(i, 1), i--)) : (this.motions = this.motions.splice(i, 1), i--);
      ...
      gt.prototype.setContext = function (t) {
        ...
        if (0 == $) return null;
        var u = 1 / $;
        return t.m[0] = u * (s * l - h * a), t.m[1] = u * (h * o - r * l), t.m[2] = u * (r * a - s * o), t.m[3] = u * (_ * a - n * l), t.m[4] = u * (i * l - _ * o), t.m[5] = u * (n * o - i * a), t.m[6] = u * (n * h - _ * s), t.m[7] = u * (_ * r - i * h), t.m[8] = u * (i * s - n * r), t;
      ...
      yt.prototype = new M(), yt._$9r = function (t) {
        ...
        if (!(n < .01 && null == this.clipBufPre_clipContextMask)) {
          ...
          _.blendEquationSeparate(_.FUNC_ADD, _.FUNC_ADD), _.blendFuncSeparate(g, d, y, m), this.anisotropyExt && _.texParameteri(_.TEXTURE_2D, this.anisotropyExt.TEXTURE_MAX_ANISOTROPY_EXT, this.maxAnisotropy);
          var T = i.length;
      ...
      function Pt(t) {
        i || (this._$P = new Int8Array(8), this._$R0 = new DataView(this._$P.buffer), this._$3i = new Int8Array(1e3), this._$hL = 0, this._$v0 = 0, this._$S2 = 0, this._$Ko = new Array(), this._$T = t, this._$F = 0);
      }
      ...
      Pt.prototype._$bT = function () {
        ...
        try {
          var o = new Array();
          if (null == e) for (r = 0; r < t; ++r) o[r] = this._$T.getUint8(this._$F++);else for (r = 0; r < t; ++r) o[r] = e[r];
          return String.fromCharCode.apply(null, o);
        } catch (t) {
      ...
      function vt() {}
      vt._$2S = Math.PI / 180, vt._$bS = Math.PI / 180, vt._$wS = 180 / Math.PI, vt._$NS = 180 / Math.PI, vt.PI_F = Math.PI, vt._$kT = [0, .012368, .024734, .037097, .049454, .061803, .074143, .086471, .098786, .111087, .12337, .135634, .147877, .160098, .172295, .184465, .196606, .208718, .220798, .232844, .244854, .256827, .268761, .280654, .292503, .304308, .316066, .327776, .339436, .351044, .362598, .374097, .385538, .396921, .408243, .419502, .430697, .441826, .452888, .463881, .474802, .485651, .496425, .507124, .517745, .528287, .538748, .549126, .559421, .56963, .579752, .589785, .599728, .609579, .619337, .629, .638567, .648036, .657406, .666676, .675843, .684908, .693867, .70272, .711466, .720103, .72863, .737045, .745348, .753536, .76161, .769566, .777405, .785125, .792725, .800204, .807561, .814793, .821901, .828884, .835739, .842467, .849066, .855535, .861873, .868079, .874153, .880093, .885898, .891567, .897101, .902497, .907754, .912873, .917853, .922692, .92739, .931946, .936359, .940629, .944755, .948737, .952574, .956265, .959809, .963207, .966457, .96956, .972514, .97532, .977976, .980482, .982839, .985045, .987101, .989006, .990759, .992361, .993811, .995109, .996254, .997248, .998088, .998776, .999312, .999694, .999924, 1], vt._$92 = function (t, e) {
      ...
      function Lt(t) {
        i || (this._$e0 = null, this._$IP = null, this._$Us = null, this._$7s = null, this._$IS = [!1], this._$VS = null, this._$AT = !0, this.baseOpacity = 1, this.clipBufPre_clipContext = null, this._$e0 = t);
      }
      ...
      Mt._$W2 = 0, Mt.SYSTEM_INFO = null, Mt.USER_AGENT = navigator.userAgent, Mt.isIPhone = function () {
        ...
        if ((i = t.indexOf("iPhone OS ")) >= 0) r.os = "iPhone", r._isIPhone = !0, r.version = e(t, i + "iPhone OS ".length);else if ((i = t.indexOf("iPad")) >= 0) {
          if ((i = t.indexOf("CPU OS")) < 0) return void a._$li(" err : " + t + " @UtHtml5.setup()");
          r.os = "iPad", r._isIPad = !0, r.version = e(t, i + "CPU OS ".length);
        } else (i = t.indexOf("Android")) >= 0 ? (r.os = "Android", r._isAndroid = !0, r.version = e(t, i + "Android ".length)) : (r.os = "-", r.version = -1);
      }, at.init();
      i = !1;
      e.UtSystem = A, e.UtDebug = a, e.LDTransform = gt, e.LDGL = ot, e.Live2D = at, e.Live2DModelWebGL = pt, e.Live2DModelJS = q, e.Live2DMotion = J, e.MotionQueueManager = ct, e.PhysicsHair = u, e.AMotion = s, e.PartsDataID = h, e.DrawDataID = b, e.BaseDataID = dt, e.ParamID = l;
    }).call(e, i(83));
  },
  78: function _(t, e, i) {
    "use strict";
    ...
    var r = i(77);
    function o() {
      this.live2DModel = null, this.modelMatrix = null, this.eyeBlink = null, this.physics = null, this.pose = null, this.debugMode = !1, this.initialized = !1, this.updating = !1, this.alpha = 1, this.accAlpha = 0, this.lipSync = !1, this.lipSyncValue = 0, this.accelX = 0, this.accelY = 0, this.accelZ = 0, this.dragX = 0, this.dragY = 0, this.startTimeMSec = null, this.mainMotionManager = new u(), this.expressionManager = new u(), this.motions = {}, this.expressions = {}, this.isTexLoaded = !1;
    }
    var n = 0;
    o.prototype.getModelMatrix = function () {
      ...
      i.loadLive2DModel(t, function (t) {
        ...
        0 == r.Live2D.getError() ? (o.modelMatrix = new $(o.live2DModel.getCanvasWidth(), o.live2DModel.getCanvasHeight()), o.modelMatrix.setWidth(2), o.modelMatrix.setCenterPosition(0, 0), e(o.live2DModel)) : console.error("Error : Failed to loadModelData().");
      });
    ...
    s.prototype = new r.AMotion(), s.EXPRESSION_DEFAULT = "DEFAULT", s.TYPE_SET = 0, s.TYPE_ADD = 1, s.TYPE_MULT = 2, s.loadJson = function (t) {
      var e = new s(),
    ...
    function _() {
      this.nextBlinkTime = null, this.stateStartTime = null, this.blinkIntervalMsec = null, this.eyeState = h.STATE_FIRST, this.blinkIntervalMsec = 4e3, this.closingMotionMsec = 100, this.closedMotionMsec = 50, this.openingMotionMsec = 150, this.closeIfZero = !0, this.eyeID_L = "PARAM_EYE_L_OPEN", this.eyeID_R = "PARAM_EYE_R_OPEN";
    }
    _.prototype.calcNextBlink = function () {
      ...
      var e,
        i = r.UtSystem.getUserTimeMSec(),
        o = 0;
      switch (this.eyeState) {
        case h.STATE_CLOSING:
          (o = (i - this.stateStartTime) / this.closingMotionMsec) >= 1 && (o = 1, this.eyeState = h.STATE_CLOSED, this.stateStartTime = i), e = 1 - o;
          break;
        case h.STATE_CLOSED:
          (o = (i - this.stateStartTime) / this.closedMotionMsec) >= 1 && (this.eyeState = h.STATE_OPENING, this.stateStartTime = i), e = 0;
          break;
        case h.STATE_OPENING:
          (o = (i - this.stateStartTime) / this.openingMotionMsec) >= 1 && (o = 1, this.eyeState = h.STATE_INTERVAL, this.nextBlinkTime = this.calcNextBlink()), e = o;
          break;
    ...
    p.load = function (t) {
      for (var e = new p(), i = y.getPlatformManager().jsonParseFromBytes(t).physics_hair, o = i.length, n = 0; n < o; n++) {
        ...
        for (f = 0; f < v; f++) {
          ...
          "angle" === (L = M.ptype) ? m = r.PhysicsHair.Target.TARGET_FROM_ANGLE : "angle_v" === L ? m = r.PhysicsHair.Target.TARGET_FROM_ANGLE_V : r.UtDebug.error("live2d", "Invalid parameter:PhysicsHair.Target");
      ...
      for (var e = r.UtSystem.getUserTimeMSec() - this.startTimeMSec, i = 0; i < this.physicsList.length; i++) this.physicsList[i].update(t, e);
    };
    function c() {
    ...
    c.load = function (t) {
      ...
      if (null != t) {
        ...
        for (var o = 0; o < this.partsGroups.length; o++) this.normalizePartsOpacityGroup(t, this.partsGroups[o], i), this.copyOpacityOtherParts(t, this.partsGroups[o]);
      }
      ...
      if (null != t) for (var e = 0; e < this.partsGroups.length; e++) for (var i = this.partsGroups[e], r = 0; r < i.length; r++) {
        ...
        if (!(o < 0)) {
          ...
          if (t.setPartsOpacity(o, s ? 1 : 0), t.setParamFloat(n, s ? 1 : 0), null != i[r].link) for (var a = 0; a < i[r].link.length; a++) i[r].link[a].initIndex(t);
        }
      }
      ...
      for (n = 0; n < e.length; n++) {
        if (!((s = e[n].partsIndex) < 0)) if (r == n) t.setPartsOpacity(s, o);else {
          ...
          (1 - (_ = o < .5 ? -.5 * o / .5 + 1 : .5 * (1 - o) / .5)) * (1 - o) > .15 && (_ = 1 - .15 / (1 - o)), h > _ && (h = _), t.setPartsOpacity(s, h);
        }
      }
    ...
    f.prototype.initIndex = function (t) {
      this.paramIndex = t.getParamIndex("VISIBLE:" + this.id), this.partsIndex = t.getPartsDataIndex(r.PartsDataID.getID(this.id)), t.setParamFloat(this.paramIndex, 1);
    };
    function g() {
    ...
    y.platformManager = null, y.getPlatformManager = function () {
      ...
      y.platformManager = t;
    }, e.L2DTargetPoint = g, e.Live2DFramework = y, e.L2DViewMatrix = d, e.L2DPose = c, e.L2DPartsParam = f, e.L2DPhysics = p, e.L2DMotionManager = u, e.L2DModelMatrix = $, e.L2DMatrix44 = l, e.EYE_STATE = h, e.L2DEyeBlink = _, e.L2DExpressionParam = a, e.L2DExpressionMotion = s, e.L2DBaseModel = o;
  },
  79: function _(t, e, i) {
    "use strict";
  ...
  80: function _(t, e, i) {
    ...
    e.createElement = function () {
      ...
      i.id = r.config.name.div, i.className = "live2d-widget-container", i.style.setProperty("position", "fixed"), i.style.setProperty(r.config.display.position, r.config.display.hOffset + "px"), i.style.setProperty("bottom", r.config.display.vOffset + "px"), i.style.setProperty("width", r.config.display.width + "px"), i.style.setProperty("height", r.config.display.height + "px"), i.style.setProperty("z-index", 99999), i.style.setProperty("opacity", r.config.react.opacity), i.style.setProperty("pointer-events", "none"), document.body.appendChild(i), o.L2Dwidget.emit("create-container", i), r.config.dialog.enable && (0, n.createDialogElement)(i);
      ...
      _.setAttribute("id", r.config.name.canvas), _.setAttribute("width", r.config.display.width * r.config.display.superSample), _.setAttribute("height", r.config.display.height * r.config.display.superSample), _.style.setProperty("position", "absolute"), _.style.setProperty("left", "0px"), _.style.setProperty("top", "0px"), _.style.setProperty("width", r.config.display.width + "px"), _.style.setProperty("height", r.config.display.height + "px"), r.config.dev.border && _.style.setProperty("border", "dashed 1px #CCC"), i.appendChild(_), e.currCanvas = a = document.getElementById(r.config.name.canvas), o.L2Dwidget.emit("create-canvas", _), function () {
        for (var t = ["webgl2", "webgl", "experimental-webgl2", "experimental-webgl", "webkit-3d", "moz-webgl"], i = 0; i < t.length; i++) try {
  ...
  82: function _(t, e, i) {
    ...
    function $() {
      ...
      t.open("get", "https://v1.hitokoto.cn"), t.setRequestHeader("Cache-Control", "no-cache"), t.onreadystatechange = function () {
        if (4 === t.readyState) {
    ...
    t.exports = {
      createDialogElement: function createDialogElement(t) {
        (n = document.createElement("div")).className = "live2d-widget-dialog-container", n.style.transform = "scale(" + r.config.display.width / 250 + ")", (s = document.createElement("div")).className = "live2d-widget-dialog", n.appendChild(s), t.appendChild(n), o.L2Dwidget.emit("create-dialog", n), r.config.dialog.hitokoto && $();
      },
      displayDialog: _,
      hiddenDialog: h,
      alertText: l,
  ...
  84: function _(t, e, i) {
    ...
    var r = i(78),
      ...
      s = i(79);
    function a(t) {
      this.eventemitter = t, this.models = [], this.count = -1, this.reloadFlg = !1, r.Live2DFramework.setPlatformManager(new o.PlatformManager());
    }
  ...
  85: function _(t, e, i) {
    ...
    n.prototype.loadBytes = function (t, e) {
      ...
      n.crossOrigin = "Anonymous", n.src = i, n.onload = onload, n.onerror = onerror, n.onload = function () {
        ...
        t.isPremultipliedAlpha() || i.pixelStorei(i.UNPACK_PREMULTIPLY_ALPHA_WEBGL, 1), i.pixelStorei(i.UNPACK_FLIP_Y_WEBGL, 1), i.activeTexture(i.TEXTURE0), i.bindTexture(i.TEXTURE_2D, s), i.texImage2D(i.TEXTURE_2D, 0, i.RGBA, i.RGBA, i.UNSIGNED_BYTE, n), i.texParameteri(i.TEXTURE_2D, i.TEXTURE_MAG_FILTER, i.LINEAR), i.texParameteri(i.TEXTURE_2D, i.TEXTURE_MIN_FILTER, i.LINEAR_MIPMAP_NEAREST), i.generateMipmap(i.TEXTURE_2D), t.setTexture(e, s), s = null, "function" == typeof o && o();
      }, n.onerror = function () {
  ...
  86: function _(t, e, i) {
    ...
    _.prototype = new r.L2DBaseModel(), _.prototype.load = function (t, e, i) {
      this.setUpdating(!0), this.setInitialized(!1), this.modelHomeDir = e.substring(0, e.lastIndexOf("/") + 1), this.modelSetting = new o.ModelSettingJson();
      var n = this;
      this.modelSetting.loadModelSetting(e, function () {
        ...
        n.loadModelData(t, function (t) {
          for (var e = 0; e < n.modelSetting.getTextureNum(); e++) {
            if (/^https?:\/\/|^\/\//i.test(n.modelSetting.getTextureFile(e))) var o = n.modelSetting.getTextureFile(e);else o = n.modelHomeDir + n.modelSetting.getTextureFile(e);
            n.loadTexture(e, o, function () {
              if (n.isTexLoaded) {
                ...
                if (null == n.eyeBlink && (n.eyeBlink = new r.L2DEyeBlink()), null != n.modelSetting.getPhysicsFile() ? n.loadPhysics(n.modelHomeDir + n.modelSetting.getPhysicsFile()) : n.physics = null, null != n.modelSetting.getPoseFile() ? n.loadPose(n.modelHomeDir + n.modelSetting.getPoseFile(), function () {
                  n.pose.updateParam(n.live2DModel);
                }) : n.pose = null, null != n.modelSetting.getLayout()) {
                  var a = n.modelSetting.getLayout();
                  null != a.width && n.modelMatrix.setWidth(a.width), null != a.height && n.modelMatrix.setHeight(a.height), null != a.x && n.modelMatrix.setX(a.x), null != a.y && n.modelMatrix.setY(a.y), null != a.center_x && n.modelMatrix.centerX(a.center_x), null != a.center_y && n.modelMatrix.centerY(a.center_y), null != a.top && n.modelMatrix.top(a.top), null != a.bottom && n.modelMatrix.bottom(a.bottom), null != a.left && n.modelMatrix.left(a.left), null != a.right && n.modelMatrix.right(a.right);
                }
                for (t = 0; t < n.modelSetting.getInitParamNum(); t++) n.live2DModel.setParamFloat(n.modelSetting.getInitParamID(t), n.modelSetting.getInitParamValue(t));
                for (t = 0; t < n.modelSetting.getInitPartsVisibleNum(); t++) n.live2DModel.setPartsOpacity(n.modelSetting.getInitPartsVisibleID(t), n.modelSetting.getInitPartsVisibleValue(t));
                n.live2DModel.saveParam(), n.preloadMotionGroup(s.cDefine.MOTION_GROUP_IDLE), n.mainMotionManager.stopAllMotions(), n.setUpdating(!1), n.setInitialized(!0), "function" == typeof i && i();
              }
            });
          }
        });
      ...
      if (null != r && "" != r) {
        if (i == s.cDefine.PRIORITY_FORCE) this.mainMotionManager.setReservePriority(i);else if (!this.mainMotionManager.reserveMotion(i)) return void (s.cDefine.DEBUG_LOG && console.log("Motion is running."));
        var o,
          n = this;
      ...
      if (r.setFadeIn(this.modelSetting.getMotionFadeIn(t, e)), r.setFadeOut(this.modelSetting.getMotionFadeOut(t, e)), s.cDefine.DEBUG_LOG && console.log("Start motion : " + o), null == this.modelSetting.getMotionSound(t, e)) this.mainMotionManager.startMotionPrio(r, i);else {
        var n = this.modelSetting.getMotionSound(t, e),
          a = document.createElement("audio");
        a.src = this.modelHomeDir + n, s.cDefine.DEBUG_LOG && console.log("Start sound : " + n), a.play(), this.mainMotionManager.startMotionPrio(r, i);
      }
...
// Change L2Dwidget. to plugin/L2Dwidget.
